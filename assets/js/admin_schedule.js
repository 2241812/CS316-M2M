...
// Make sure your helper function accepts the labelKey
function populateSelect(elementId, items, labelKey = 'name') {
    ...
    items.forEach(item => {
        ...
        // This line checks if labelKey exists, otherwise falls back to generic text
